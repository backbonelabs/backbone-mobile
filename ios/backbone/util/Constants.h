...
#define DEVICE_STATUS_CHARACTERISTIC_UUID         [CBUUID UUIDWithString:@"00010009-0000-1000-8000-00805F9B0421"]
...
#define SESSION_OPERATION_SELF_TEST   4
...
#define SESSION_COMMAND_SELF_TEST     0x04
...
#define FIREHOSE_POSTURE_SESSION_STREAM @"PostureSessionAccelerometerDeliveryStream2"
#define FIREHOSE_POSTURE_SESSION        @"PostureSessionDeliveryStream2"
