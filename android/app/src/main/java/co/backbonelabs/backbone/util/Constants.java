...
public class Constants {
    ...
    public interface CHARACTERISTIC_UUIDS {
        UUID SESSION_CONTROL_CHARACTERISTIC = UUID.fromString("00010001-0000-1000-8000-805F9B34FB00");
        UUID DISTANCE_CHARACTERISTIC = UUID.fromString("00010002-0000-1000-8000-805F9B34FB00");
